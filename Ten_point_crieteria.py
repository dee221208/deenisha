...
stock_list=["SANOFI.NS"]         

#stock_list=["POWERGRID","SANOFI","MARICO","BRITANNIA","HINDUNILVR","POLYPLEX","PIDILITIND","ASTRAL","ASIANPAINT","RELAXO","AARTIIND","BERGEPAINT","HONAUT","VINATIORGA","RATNAMANI","ALKYLAMINE","MIDHANI","GRSE","ICICIGI","TCIEXP","SUVENPHAR","FINEORG","DIXON","DMART","TASTYBITE","LTTS","INDIAMART","TIINDIA","AFFLE","APLLTD","AMARAJABAT","SANOFI","GSPL","COROMANDEL","POWERGRID","PETRONET","GODFRYPHLP","ABBOTINDIA","BRITANNIA","NESTLEIND","GRANULES","COLPAL","IPCALAB","ESCORTS","MARICO","JKLAKSHMI","HINDUNILVR","BBTC","IOLCP","LUXIND","WELCORP","BIRLACORPN","GUJGASLTD","PIDILITIND","AARTIIND","ASIANPAINT","BERGEPAINT","PAGEIND","TIMKEN","BLUESTARCO","LALPATHLAB","DEEPAKNTR","GMBREW","SAGCEM","ALKYLAMINE","ASTEC","COSMOFILMS","CYBERTECH","DAAWAT","ESABINDIA","ESTER","EXCELINDUS","FILATEX","GOODLUCK","GRSE","IOLCP","JOCIL","KINGFA","LINCOLN","MAANALU","MARKSANS","MASTEK","MOLDTECH","NAHARPOLY","NRAIL","ORIENTABRA","PDSMFL","PLASTIBLEN","POLYPLEX","PREMIERPOL","REFEX","ROSSELLIND","RPGLIFE","RSYSTEMS","SAKSOFT","SAREGAMA","SEAMECLTD","SPLIL","SREEL","SRHHYPOLTD","TRIVENI","VIDHIING","XCHANGING"]

for stock in range(0,len(stock_list)):
    is_available(stock_list[stock])
